...
This is the official codebase for SIGGRAPH Aisa 2025 paper: _GSWT: Gaussian Splatting Wang Tiles_ ([Project page](https://yunfan.zone/gswt_webpage/)). It only contains the GWST renderer. For the GSWT constructor part, please visit the other repository: TBD.
